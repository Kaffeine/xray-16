...
void CScriptGameObject::ForEachInventoryItems(const luabind::functor<void> &functor)
{
	...
	if(!owner){
		ai().script_engine().script_log		(LuaMessageType::Error,"CScriptGameObject::ForEachInventoryItems non-CInventoryOwner object !!!");
		return;
	}
...
void CScriptGameObject::IterateInventory	(luabind::functor<void> functor, luabind::object object)
{
	...
	if (!inventory_owner) {
		ai().script_engine().script_log		(LuaMessageType::Error,"CScriptGameObject::IterateInventory non-CInventoryOwner object !!!");
		return;
	}
...
void CScriptGameObject::IterateInventoryBox	(luabind::functor<void> functor, luabind::object object)
{
	...
	if (!inventory_box) {
		ai().script_engine().script_log		(LuaMessageType::Error,"CScriptGameObject::IterateInventoryBox non-CInventoryBox object !!!");
		return;
	}
...
void CScriptGameObject::MarkItemDropped		(CScriptGameObject *item)
{
	...
	if (!inventory_owner) {
		ai().script_engine().script_log		(LuaMessageType::Error,"CScriptGameObject::MarkItemDropped non-CInventoryOwner object !!!");
		return;
	}

	CInventoryItem			*inventory_item = smart_cast<CInventoryItem*>(&item->object());
	if (!inventory_item) {
		ai().script_engine().script_log		(LuaMessageType::Error,"CScriptGameObject::MarkItemDropped non-CInventoryItem object !!!");
		return;
	}
...
bool CScriptGameObject::MarkedDropped		(CScriptGameObject *item)
{
	CInventoryOwner			*inventory_owner = smart_cast<CInventoryOwner*>(&object());
	if (!inventory_owner) {
		ai().script_engine().script_log		(LuaMessageType::Error,"CScriptGameObject::MarkedDropped non-CInventoryOwner object !!!");
		return				(false);
	}

	CInventoryItem			*inventory_item = smart_cast<CInventoryItem*>(&item->object());
	if (!inventory_item) {
		ai().script_engine().script_log		(LuaMessageType::Error,"CScriptGameObject::MarkedDropped non-CInventoryItem object !!!");
		return				(false);
	}
...
void CScriptGameObject::UnloadMagazine		()
{
	...
	if (!weapon_magazined) {
		ai().script_engine().script_log		(LuaMessageType::Error,"CScriptGameObject::UnloadMagazine non-CWeaponMagazined object !!!");
		return;
	}
...
void CScriptGameObject::DropItem			(CScriptGameObject* pItem)
{
	...
	if(!owner||!item){
		ai().script_engine().script_log		(LuaMessageType::Error,"CScriptGameObject::DropItem non-CInventoryOwner object !!!");
		return;
	}
...
int CScriptGameObject::GetCommunityGoodwill_obj( LPCSTR community )
{
	...
	if (!pInventoryOwner) {
		ai().script_engine().script_log		(LuaMessageType::Error,"GetCommunityGoodwill available only for InventoryOwner");
		return 0;
	}
...
void CScriptGameObject::SetCommunityGoodwill_obj( LPCSTR community, int goodwill )
{
	...
	if (!pInventoryOwner) {
		ai().script_engine().script_log		(LuaMessageType::Error,"SetCommunityGoodwill available only for InventoryOwner");
		return;
	}
	CHARACTER_COMMUNITY c;
	c.set( community );
...
int CScriptGameObject::CharacterRank			()
{
	...
	if (!monster) {
		CInventoryOwner* pInventoryOwner = smart_cast<CInventoryOwner*>(&object());
		if (!pInventoryOwner) {
			ai().script_engine().script_log		(LuaMessageType::Error,"CharacterRank available only for InventoryOwner and BaseMonster");
			return 0;
		}
...
void CScriptGameObject::ChangeCharacterReputation		(int char_rep)
{
	...
	if (!pInventoryOwner) {
		ai().script_engine().script_log		(LuaMessageType::Error,"ChangeCharacterReputation available only for InventoryOwner");
		return ;
	}
...
void CScriptGameObject::SetCharacterCommunity	(LPCSTR comm, int squad, int group)
{
	...
	if (!pInventoryOwner || !entity) {
		ai().script_engine().script_log		(LuaMessageType::Error,"SetCharacterCommunity available only for InventoryOwner");
		return;
	}
...
void CScriptGameObject::add_restrictions		(LPCSTR out, LPCSTR in)
{
	...
	if (!monster) {
		ai().script_engine().script_log		(LuaMessageType::Error,"CRestrictedObject : cannot access class member add_restrictions!");
		return;
	}
...
void CScriptGameObject::remove_restrictions		(LPCSTR out, LPCSTR in)
{
	CCustomMonster	*monster = smart_cast<CCustomMonster*>(&object());
	if (!monster) {
		ai().script_engine().script_log		(LuaMessageType::Error,"CRestrictedObject : cannot access class member remove_restrictions!");
		return;
	}
...
void CScriptGameObject::remove_all_restrictions	()
{
	CCustomMonster	*monster = smart_cast<CCustomMonster*>(&object());
	if (!monster) {
		ai().script_engine().script_log		(LuaMessageType::Error,"CRestrictedObject : cannot access class member remove_all_restrictions!");
		return;
	}
...
LPCSTR CScriptGameObject::in_restrictions	()
{
	CCustomMonster	*monster = smart_cast<CCustomMonster*>(&object());
	if (!monster) {
		ai().script_engine().script_log		(LuaMessageType::Error,"CRestrictedObject : cannot access class member in_restrictions!");
		return								("");
	}
...
LPCSTR CScriptGameObject::out_restrictions	()
{
	CCustomMonster	*monster = smart_cast<CCustomMonster*>(&object());
	if (!monster) {
		ai().script_engine().script_log		(LuaMessageType::Error,"CRestrictedObject : cannot access class member out_restrictions!");
		return								("");
	}
...
LPCSTR CScriptGameObject::base_in_restrictions	()
{
	CCustomMonster	*monster = smart_cast<CCustomMonster*>(&object());
	if (!monster) {
		ai().script_engine().script_log		(LuaMessageType::Error,"CRestrictedObject : cannot access class member base_in_restrictions!");
		return								("");
	}
...
LPCSTR CScriptGameObject::base_out_restrictions	()
{
	CCustomMonster	*monster = smart_cast<CCustomMonster*>(&object());
	if (!monster) {
		ai().script_engine().script_log		(LuaMessageType::Error,"CRestrictedObject : cannot access class member base_out_restrictions!");
		return								("");
	}
...
bool CScriptGameObject::accessible_position	(const Fvector &position)
{
	CCustomMonster	*monster = smart_cast<CCustomMonster*>(&object());
	if (!monster) {
		ai().script_engine().script_log		(LuaMessageType::Error,"CRestrictedObject : cannot access class member accessible!");
		return								(false);
	}
...
u32	 CScriptGameObject::accessible_nearest	(const Fvector &position, Fvector &result)
{
	...
	if (monster->movement().restrictions().accessible(position)) {
		ai().script_engine().script_log		(LuaMessageType::Error,"CRestrictedObject : you use accessible_nearest when position is already accessible!");
		return								(u32(-1));
	}
...
void CScriptGameObject::enable_attachable_item	(bool value)
{
	...
	if (!attachable_item) {
		ai().script_engine().script_log		(LuaMessageType::Error,"CAttachableItem : cannot access class member enable_attachable_item!");
		return;
	}
...
bool CScriptGameObject::attachable_item_enabled	() const
{
	CAttachableItem							*attachable_item = smart_cast<CAttachableItem*>(&object());
	if (!attachable_item) {
		ai().script_engine().script_log		(LuaMessageType::Error,"CAttachableItem : cannot access class member attachable_item_enabled!");
		return								(false);
	}
...
void CScriptGameObject::enable_night_vision	(bool value)
{
	...
	if (!torch) {
		ai().script_engine().script_log		(LuaMessageType::Error,"CTorch : cannot access class member enable_night_vision!");
		return;
	}
...
void CScriptGameObject::attachable_item_load_attach(LPCSTR section)
{
	CAttachableItem							*attachable_item = smart_cast<CAttachableItem*>(&object());
	if (!attachable_item) {
		ai().script_engine().script_log		(LuaMessageType::Error,"CAttachableItem : cannot access class member attachable_item_load_attach!");
		return;
	}
...
int CScriptGameObject::Weapon_GrenadeLauncher_Status()
{
	...
	if ( !weapon )
	{
		ai().script_engine().script_log		(LuaMessageType::Error,"CWeapon : cannot access class member Weapon_GrenadeLauncher_Status!");
		return								(false);
	}
...
int CScriptGameObject::Weapon_Scope_Status()
{
	...
	if ( !weapon )
	{
		ai().script_engine().script_log		(LuaMessageType::Error,"CWeapon : cannot access class member Weapon_Scope_Status!");
		return								(false);
	}
...
int CScriptGameObject::Weapon_Silencer_Status()
{
	...
	if ( !weapon )
	{
		ai().script_engine().script_log		(LuaMessageType::Error,"CWeapon : cannot access class member Weapon_Silencer_Status!");
		return								(false);
	}
...
bool CScriptGameObject::Weapon_IsGrenadeLauncherAttached()
{
	...
	if ( !weapon )
	{
		ai().script_engine().script_log		(LuaMessageType::Error,"CWeapon : cannot access class member Weapon_IsGrenadeLauncherAttached!");
		return								(false);
	}
...
bool CScriptGameObject::Weapon_IsScopeAttached()
{
	...
	if ( !weapon )
	{
		ai().script_engine().script_log		(LuaMessageType::Error,"CWeapon : cannot access class member Weapon_IsScopeAttached!");
		return								(false);
	}
...
bool CScriptGameObject::Weapon_IsSilencerAttached()
{
	...
	if ( !weapon )
	{
		ai().script_engine().script_log		(LuaMessageType::Error,"CWeapon : cannot access class member Weapon_IsSilencerAttached!");
		return								(false);
	}
...
CScriptGameObject *CScriptGameObject::active_detector	() const
{
	CInventoryOwner	*inventory_owner = smart_cast<CInventoryOwner*>(&object());
	if (!inventory_owner) {
		ai().script_engine().script_log			(LuaMessageType::Error,"CInventoryOwner : cannot access class member active_detector!");
		return		(0);
	}
...
CScriptGameObject *CScriptGameObject::item_in_slot	(u32 slot_id) const
{
	CInventoryOwner	*inventory_owner = smart_cast<CInventoryOwner*>(&object());
	if (!inventory_owner) {
		ai().script_engine().script_log			(LuaMessageType::Error,"CInventoryOwner : cannot access class member item_in_slot!");
		return		(0);
	}
...
u32	CScriptGameObject::active_slot()
{
	CInventoryOwner	*inventory_owner = smart_cast<CInventoryOwner*>(&object());
	if (!inventory_owner) {
		ai().script_engine().script_log			(LuaMessageType::Error,"CInventoryOwner : cannot access class member active_slot!");
		return		(0);
	}
...
void CScriptGameObject::activate_slot	(u32 slot_id)
{
	CInventoryOwner	*inventory_owner = smart_cast<CInventoryOwner*>(&object());
	if (!inventory_owner) {
		ai().script_engine().script_log			(LuaMessageType::Error,"CInventoryOwner : cannot access class member activate_slot!");
		return						;
	}
...
void CScriptGameObject::enable_movement	(bool enable)
{
	CCustomMonster						*monster = smart_cast<CCustomMonster*>(&object());
	if (!monster) {
		ai().script_engine().script_log	(LuaMessageType::Error,"CCustomMonster : cannot access class member movement_enabled!");
		return;
	}
...
bool CScriptGameObject::can_throw_grenades	() const
{
	...
	if (!stalker) {
		ai().script_engine().script_log	(LuaMessageType::Error,"CAI_Stalker : cannot access class member can_throw_grenades!");
		return							(false);
	}
...
u32 CScriptGameObject::throw_time_interval			() const
{
	CAI_Stalker							*stalker = smart_cast<CAI_Stalker*>(&object());
	if (!stalker) {
		ai().script_engine().script_log	(LuaMessageType::Error,"CAI_Stalker : cannot access class member throw_time_interval!");
		return							(0);
	}
...
u32 CScriptGameObject::group_throw_time_interval	() const
{
	CAI_Stalker							*stalker = smart_cast<CAI_Stalker*>(&object());
	if (!stalker) {
		ai().script_engine().script_log	(LuaMessageType::Error,"CAI_Stalker : cannot access class member group_throw_time_interval!");
		return							(0);
	}
...
void CScriptGameObject::aim_time					(CScriptGameObject *weapon, u32 aim_time)
{
	...
	if (!weapon_) {
		ai().script_engine().script_log	(LuaMessageType::Error,"CAI_Stalker : cannot access class member aim_time (not a weapon passed)!");
		return;
	}
...
void CScriptGameObject::special_danger_move			(bool value)
{
	CAI_Stalker							*stalker = smart_cast<CAI_Stalker*>(&object());
	if (!stalker) {
		ai().script_engine().script_log	(LuaMessageType::Error,"CAI_Stalker : cannot access class member special_danger_move!");
		return;
	}
...
void CScriptGameObject::sniper_update_rate			(bool value)
{
	CAI_Stalker							*stalker = smart_cast<CAI_Stalker*>(&object());
	if (!stalker) {
		ai().script_engine().script_log	(LuaMessageType::Error,"CAI_Stalker : cannot access class member sniper_update_rate!");
		return;
	}
...
void CScriptGameObject::sniper_fire_mode			(bool value)
{
	CAI_Stalker							*stalker = smart_cast<CAI_Stalker*>(&object());
	if (!stalker) {
		ai().script_engine().script_log	(LuaMessageType::Error,"CAI_Stalker : cannot access class member sniper_fire_mode!");
		return;
	}
...
void CScriptGameObject::register_in_combat						()
{
	CAI_Stalker							*stalker = smart_cast<CAI_Stalker*>(&object());
	if (!stalker) {
		ai().script_engine().script_log	(LuaMessageType::Error, "CAI_Stalker : cannot access class member register_in_combat!");
		return;
	}
...
void CScriptGameObject::unregister_in_combat					()
{
	CAI_Stalker							*stalker = smart_cast<CAI_Stalker*>(&object());
	if (!stalker) {
		ai().script_engine().script_log	(LuaMessageType::Error, "CAI_Stalker : cannot access class member unregister_in_combat!");
		return;
	}
...
CCoverPoint const* CScriptGameObject::find_best_cover			(Fvector position_to_cover_from)
{
	CAI_Stalker							*stalker = smart_cast<CAI_Stalker*>(&object());
	if (!stalker) {
		ai().script_engine().script_log	(LuaMessageType::Error, "CAI_Stalker : cannot access class member find_best_cover!");
		return							(0);
	}
...
{
	if (!object) {
		ai().script_engine().script_log	(LuaMessageType::Error, "CAI_Stalker::suitable_smart_cover null smart cover specified!");
		return							(false);
	}

	CAI_Stalker							*stalker = smart_cast<CAI_Stalker*>(&this->object());
	if (!stalker) {
		ai().script_engine().script_log	(LuaMessageType::Error, "CAI_Stalker : cannot access class member suitable_smart_cover!");
		return							(false);
	}

	smart_cover::object const* const	smart_object = smart_cast<smart_cover::object const*>(&object->object());
	if (!smart_object) {
		ai().script_engine().script_log	(LuaMessageType::Error, "CAI_Stalker : suitable_smart_cover: passed non-smart_cover object!");
		return							(false);
	}
...
void CScriptGameObject::take_items_enabled						(bool const value)
{
	...
	if (!stalker) {
		ai().script_engine().script_log	(LuaMessageType::Error, "CAI_Stalker : cannot access class member take_items_enabled!");
		return;
	}
...
void CScriptGameObject::SetPlayShHdRldSounds(bool val)
{
	...
	if (!owner) 
	{
		ai().script_engine().script_log(LuaMessageType::Error,"CInventoryOwner : cannot access class member SetPlayShHdRldSounds!");
		return;
	}
...
void CScriptGameObject::death_sound_enabled						(bool const value)
{
	CAI_Stalker* const					stalker = smart_cast<CAI_Stalker*>(&this->object());
	if (!stalker) {
		ai().script_engine().script_log	(LuaMessageType::Error, "CAI_Stalker : cannot access class member death_sound_enabled!");
		return;
	}
